/*
 * 3.Uma locadora  de jogos deseja  realizar uma promoção  na qual, para cada 10 jogos 
 * retirados, o cliente tem direito a uma locação grátis.  
 * Para realizar esta promoção entre seus 10 clientes, registrou no mês de setembro,  o número 
 * do cliente (valor entre 1 e 10),  dia da retirada  e quantidade de jogos retirados por ele 
 * neste dia. 
 * O mesmo cliente pode realizar várias retiradas no mês de setembro.
 * 
 ...
 * 
 * b) Mostre, também, ao final, o número médio de retiradas por dia do mês, qual(is) o(s) dia(s)
 * com menor retirada.
 */
