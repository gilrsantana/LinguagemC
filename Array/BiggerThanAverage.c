/*
 * Show how many array's values are bigger than the average of array's values
 */
...
int biggerValue(int v[], int elements, float reference);
...
void creatArray(int size){
	...
	count = biggerValue(array1, size, average);
	printf("\nThe array has %d values bigger than array's average (%.1f)\n\n", count, average);
